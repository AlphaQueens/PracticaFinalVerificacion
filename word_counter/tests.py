...
import mock, pytest
from word_counter.views import delete_bad_chars, delete_stop_words, delete_numbers_from_string, clean_tweets, conection, remove_links

class old_tests(TestCase):
...
class Test(TestCase):
    @mock.patch('word_counter.views.delete_bad_chars')
...
class Test2(TestCase):
    @mock.patch('word_counter.views.clean_tweets')
...
class Test3(TestCase):
    @mock.patch('word_counter.views.conection')
